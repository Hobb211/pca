...
class resueltos_curvas extends StatelessWidget{
              ...
              children: <Widget>[
                ...
                Divider(height: scaleHeigth*30,),
                 Container(
                   width: scaleHeigth*300,
                            ...
                            child: Image(image: AssetImage("assets/resuelto curvas1.png")),
                ...
                Divider(height: scaleHeigth*10,),
                 Container(
                   width: scaleHeigth*300,
                            height: scaleHeigth*300,
                            child: Image(image: AssetImage("assets/resuelto curvas2.png")),
                            padding: EdgeInsets.all(1),
                ...
                Container(
                   width: scaleHeigth*300,
                            height: scaleHeigth*300,
                            child: Image(image: AssetImage("assets/resuelto curvas3.png")),
                            padding: EdgeInsets.all(1),
