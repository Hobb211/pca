...
class QueEsUnaCurva extends StatelessWidget{
  ...
  Text texto(double scale){
    return Text(
      "Las curvas de nivel son uno de los variados métodos que se utilizan para reflejar la forma tridimensional de la superficie terrestre en un mapa bidimensional."
       ,
      style: TextStyle(
          fontSize: (24*scale)
      ),
