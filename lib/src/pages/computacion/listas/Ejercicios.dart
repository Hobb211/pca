...
class EjerciciosL extends StatelessWidget{
            ...
            children: <Widget>[
              ...
              InkWell(
                ...
                //onPressed: ()=>_profe(context),
                  child: Image(image: AssetImage("assets/insert_list.png"),height: 220,)
              ),
              ...
              InkWell(
                //tyle: boton,
                //onPressed: ()=>_profe(context),
                  child: Image(image: AssetImage("assets/insert_first.png"),height: 200,)
              ),
      ...
      builder: (context){
        return AlertDialog(
          ...
          content: Container(
            height: 200,
            width: 100,
            child: Text("Principalmente podemos observar "
                "los distintos métodos aplicables a las listas "
