...
class EjerciciosC extends StatefulWidget{

  @override
  State<EjerciciosC> createState() => _EjerciciosCState();
}

class _EjerciciosCState extends State<EjerciciosC> {
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Text("Si A = 1, B = 1, C-1 = 0; "
                            "que nivel logico poseen S y C = ?",style: TextStyle(fontSize:20,color: Colors.black87),),
                      ),
                    ),
                  ],
                ),
                  ...
                  children: <Widget>[
                    InkWell(
                        child: Container(
                          ...
                          child: Image(image: AssetImage("assets/logic_exercise.png"),height: 225),
                        )
              ...
              InkWell(
                ...
                onTap: (){
                  ...
                  if (isValid){
                    ...
                    if(puntaje>= 2){resultado="Aprobado";}else{resultado="Reprobado";}
                    _resultado(context);
                  }
                },
              ),
              ...
              child:Column(
                children: [
                  ...
                  Container(
                    ...
                    width: MediaQuery.of(context).size.width,
                    padding: EdgeInsets.all(20),
                    child: Center(child:Text("Puntaje: ${puntaje-1}/2 ",style: TextStyle(fontSize: 20),)),
                  ),
                  Divider(),
                  Container(
                    decoration: container,
                  ...
                  Container(
                    ...
                    width: MediaQuery.of(context).size.width,
                    padding: EdgeInsets.all(20),
                      child: Center(child:Text("S = ${RP1} "
                        "C = ${RP2}",style: TextStyle(fontSize: 20),))
                  ),
                ],
              ),
            ),
